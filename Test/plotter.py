...
def plotBuildTreeAnalysis():
  data = pd.read_csv("Results/BuildTree.csv")
...
def plotUpdateAnalysis():
  data=pd.read_csv("Results/update.csv")
...
def plotDeleteAnalysis():
  data=pd.read_csv("Results/delete.csv")
  fig, axs = plt.subplots(3, figsize=(10, 10))
  axs[0].set_ylabel("Excution Time")
...
def plotSearchAnalysis():
  data=pd.read_csv("Results/Search.csv")
  fig, axs = plt.subplots(3, figsize=(10, 10))
  axs[0].set_ylabel("Excution Time")
