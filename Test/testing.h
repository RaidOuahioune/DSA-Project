...
namespace Test
{
  ...
  {
    ofstream file;
    file.open("Test/Results/BuildTree.csv", ios_base::app);
  ...
  {
    ofstream file;
    file.open("Test/Results/Search.csv", ios_base::app);
    FileHandler handler;
    vector<Patient> allPatients = handler.getALLPatient();
    file << allPatients.size() << ',';
    BST BinaryTree;
  ...
  {
    fstream file;
    file.open("Test/Results/Insert.csv", ios_base::app);
    FileHandler handler;
    vector<Patient> allPatients = handler.getALLPatient();
    file << allPatients.size() << ',';
    BST BinaryTree;
  ...
  {
    ofstream file;
    file.open("Test/Results/update.csv", ios_base::app);
  ...
  {
    ofstream file;
    file.open("Test/Results/delete.csv", ios_base::app);
    FileHandler handler;
    vector<Patient> allPatients = handler.getALLPatient();
    file << allPatients.size() << ',';
    BST BinaryTree;
